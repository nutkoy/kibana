...
export const CORRELATIONS_DETAILS_BY_ANCESTRY_SECTION_ICON_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_ANCESTRY_SECTION_TEST_ID}Icon` as const;
export const CORRELATIONS_DETAILS_BY_ANCESTRY_SECTION_VALUE_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_ANCESTRY_SECTION_TEST_ID}Value` as const;
export const CORRELATIONS_DETAILS_BY_ANCESTRY_SECTION_LOADING_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_ANCESTRY_SECTION_TEST_ID}Loading` as const;
export const CORRELATIONS_DETAILS_BY_SOURCE_SECTION_TEST_ID =
  `${CORRELATIONS_DETAILS_TEST_ID}AlertsBySourceSection` as const;
export const CORRELATIONS_DETAILS_BY_SOURCE_SECTION_ICON_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_SOURCE_SECTION_TEST_ID}Icon` as const;
export const CORRELATIONS_DETAILS_BY_SOURCE_SECTION_VALUE_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_SOURCE_SECTION_TEST_ID}Value` as const;
export const CORRELATIONS_DETAILS_BY_SOURCE_SECTION_LOADING_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_SOURCE_SECTION_TEST_ID}Loading` as const;
export const CORRELATIONS_DETAILS_BY_SESSION_SECTION_TEST_ID =
  `${CORRELATIONS_DETAILS_TEST_ID}AlertsBySessionSection` as const;
export const CORRELATIONS_DETAILS_BY_SESSION_SECTION_ICON_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_SESSION_SECTION_TEST_ID}Icon` as const;
export const CORRELATIONS_DETAILS_BY_SESSION_SECTION_VALUE_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_SESSION_SECTION_TEST_ID}Value` as const;
export const CORRELATIONS_DETAILS_BY_SESSION_SECTION_LOADING_TEST_ID =
  `${CORRELATIONS_DETAILS_BY_SESSION_SECTION_TEST_ID}Loading` as const;
export const CORRELATIONS_DETAILS_CASES_SECTION_TEST_ID =
  `${CORRELATIONS_DETAILS_TEST_ID}CasesSection` as const;
export const CORRELATIONS_DETAILS_CASES_SECTION_ICON_TEST_ID =
  `${CORRELATIONS_DETAILS_CASES_SECTION_TEST_ID}Icon` as const;
export const CORRELATIONS_DETAILS_CASES_SECTION_VALUE_TEST_ID =
  `${CORRELATIONS_DETAILS_CASES_SECTION_TEST_ID}Value` as const;
export const CORRELATIONS_DETAILS_CASES_SECTION_LOADING_TEST_ID =
  `${CORRELATIONS_DETAILS_CASES_SECTION_TEST_ID}Loading` as const;
